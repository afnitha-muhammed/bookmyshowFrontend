...
const items = [
  ...
  return (
    ...
    <div className="slider-container">
      <Slider {...settings}>
        <div>
        <img src="./assets/img/film1.avif"  style={{ width: '15rem',marginLeft:'10px',borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3'>Paradise</h3>
        <p className='subfilmname ms-3'>Action/Triller</p>
        </div>
        <div>
        <img src="./assets/img/film2.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px'}} />
        <h3 className='filmname mt-3 ms-3'>Kalki 2898 AC</h3>
        <p className='subfilmname ms-3'>Action/Triller</p>
        </div>
        <div>
        <img src="./assets/img/film3.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3'>Maharaja</h3>
        <p className='subfilmname ms-3'>Action/Drama</p>
        </div>
        <div>
        <img src="./assets/img/film4.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3'>Ulladakkam</h3>
        <p className='subfilmname ms-3'>Drama/Family</p>
        </div>
        <div>
        <img src="./assets/img/film5.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3'>Gaganachari</h3>
        <p className='subfilmname ms-3'>Action/Triller</p>
        </div>
        <div>
        <img src="./assets/img/film6.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3'>Golam</h3>
        <p className='subfilmname ms-3'>Action/Triller</p>
        </div>
        <div>
        <img src="./assets/img/film7.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3'>Nadanna Sambavam</h3>
        <p className='subfilmname ms-3'>Action/Triller</p>
        </div>
        <div>
        <img src="./assets/img/film8.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3'>Day One</h3>
        <p className='subfilmname ms-3'>Action/Triller</p>
        </div>
        <div>
        <img src="./assets/img/film9.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
      ...
      <section classname="section1">
          <img src="./assets/img/ad1.avif" className='w-100 my-5' />
      </section>
    ...
    <div className="slider-container">
    <img src="./assets/img/premier.avif" alt="" className='mb-3 w-100 mt-2' />
    ...
    <p className='subfilmname ms-3 text-white'>Brand New Release every Friday</p>
      <Slider {...settings} className='mb-2'>
        <div>
        <img src="./assets/img/premier1.avif"  style={{ width: '15rem',marginLeft:'10px',borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3 text-white'>The Garfield Movie</h3>
        <p className='subfilmname ms-3 text-white'>English</p>
        </div>
        <div>
        <img src="./assets/img/premier2.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px'}} />
        <h3 className='filmname mt-3 ms-3 text-white'>I Heard the Bells</h3>
        <p className='subfilmname ms-3 text-white'>English</p>
        </div>
        <div>
        <img src="./assets/img/premier3.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3 text-white'>A Furiosa: A Mad Max Saga</h3>
        <p className='subfilmname ms-3 text-white'>English</p>
        </div>
        <div>
        <img src="./assets/img/premier4.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3 text-white'>Visions</h3>
        <p className='subfilmname ms-3 text-white'>French</p>
        </div>
        <div>
        <img src="./assets/img/premier5.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3 text-white'>The Seeding</h3>
        <p className='subfilmname ms-3 text-white'>English</p>
        </div>
        <div>
        <img src="./assets/img/premier6.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3 text-white'>IF (2024)</h3>
        <p className='subfilmname ms-3 text-white'>English</p>
        </div>
        <div>
        <img src="./assets/img/premier7.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3 text-white'>Just Paas</h3>
        <p className='subfilmname ms-3 text-white'>Kannada</p>
        </div>
        <div>
        <img src="./assets/img/premier8.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3 text-white'>A Furiosa: A Mad Max Saga</h3>
        <p className='subfilmname ms-3 text-white'>English</p>
        </div>
      </Slider>
    ...
    <h2 className='fs-3 text-left ms-2 mb-2 mt-5'>Top Sports Events</h2>
      <Slider {...settings} className='mb-2'>
        <div>
        <img src="./assets/img/sports1.avif"  style={{ width: '15rem',marginLeft:'10px',borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3'>Run for the Ocean: Get Medal by Courier</h3>
        <p className='subfilmname ms-3'>$390</p>
        </div>
        <div>
        <img src="./assets/img/sports2.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px'}} />
        <h3 className='filmname mt-3 ms-3'>International Virtual Marathon</h3>
        <p className='subfilmname ms-3'>$550</p>
        </div>
        <div>
        <img src="./assets/img/sport3.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
        <h3 className='filmname mt-3 ms-3'>Freedom Virtual marathon</h3>
        <p className='subfilmname ms-3'>$300</p>
        </div>
        <div>
        <img src="./assets/img/sport4.avif" alt="no-image"  style={{ width: '15rem',marginLeft:'10px', borderRadius:'10px' }} />
